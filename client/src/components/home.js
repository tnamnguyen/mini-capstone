      ...
      <div class="home_main_container" data-testid="home_main_container">
        ...
        <div class="home_main_profile">
          <div>
            ...
            <text>Bio</text>
            <br></br>
            <text>Who viewed your profile: 34</text>
            <br></br>
            <text>Total Connections: 12</text>
            <br></br>
          </div>
        </div>
        ...
        <div class="home_posts">
          <div>
            <text>User Likes this</text>
            <br></br>
            <text>User got a new job</text>
            <br></br>
        ...
        <div class="home_news">
          <div>
            <text>Jubilee News #1</text>
            <br></br>
            <text>Jubilee News #2</text>
            <br></br>
            <text>Jubilee News #3</text>
            <br></br>
          </div>
        </div>
      </div>
